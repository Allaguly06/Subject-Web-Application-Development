...
// ============================================
// 2. ФУНКЦИЯ ДЛЯ ВАРИАНТА 2 
// f(x) = (10 + x) / x, при x ≤ 10
// f(x) = (x/7) * (x-2), при 10 < x < 20
// f(x) = x * 8 + 2, при x ≥ 20
// ============================================
...
function calculate_f($x) {
    ...
    elseif ($x < 20) {
        ...
        // Деления на ноль нет (знаменатель 7)
        return ($x / 7) * ($x - 2);
    } 
    else {
        // Третья ветка: x * 8 + 2
...
<head>
    ...
    <title>ЛР2 — Чарыев Аллагулы, группа 241-353, вариант 2</title>
...
<header>
    ...
    <div class="header-text">
        Чарыев Аллагулы | Группа 241-353 | Лабораторная работа №2 | Вариант 2
    </div>
</header>
